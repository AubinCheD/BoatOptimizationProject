...
#add conversions before the calculation
...
class Computation ():
    ...
    def __init__ (self, inputDictionary, size):   #size = size of the vector of speeds
        ...
        #intermediate calculation
            ...
            'theta': {'value': None, 'constant': True, 'output': False},
            ...
            'verticalAcceleration': {'value': None, 'constant': True, 'output': True}
    ...
    def __str__(self):
        ...
        for i in range (self.size):
            print("{} ({}) : {} (lbf)".format(self.inputDictionary['V']['value1'][i], self.inputDictionary['V']['unit1'], self.dictionary['Fh']['value'][i]))
    ...
    def calc(self, roundingPrecision = 10):
        #with Timer.LoggerTimer("Trim {}".format(10)):
    ...
    def calc_theta(self, B, LWL, beta, beta_x, roundingPrecision = 10, index = -1):   #ok
        #assert (index >= -1), 'Out Of range Index given as parameter'
        #assert (isinstance(index, int)), 'Type Error for Index : given ' + str(type(index)) + ', must be ' + str(type(int()))
        if index == -1:
            firstIndex = 0
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            temp1 = math.tan(math.radians(beta))
            temp2 = math.tan(math.radians(beta_x))
            temp3 = LWL/2
            self.dictionary['theta']['value'][i] = round(math.degrees(math.atan(B/2/temp3*(temp2-temp1))), roundingPrecision)
    ...
    def calc_trim_eL(self, roundingPrecision = 10, index = -1):      #ok
        #assert (index >= -1), 'Out Of range Index given as parameter'
        #assert (isinstance(index, int)), 'Type Error for Index : given ' + str(type(index)) + ', must be ' + str(type(int()))
        if index == -1:
            firstIndex = 0
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            self.dictionary['trim_eL']['value'][i] = round(self.dictionary['trim']['value'][i] + 0.12*self.dictionary['theta']['value'][i],  roundingPrecision)
        
    def calc_trim_eD(self, roundingPrecision = 10, index = -1):      #ok
        #assert (index >= -1), 'Out Of range Index given as parameter'
        #assert (isinstance(index, int)), 'Type Error for Index : given ' + str(type(index)) + ', must be ' + str(type(int()))
        if index == -1:
            firstIndex = 0
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            self.dictionary['trim_eD']['value'][i] = round(self.dictionary['trim']['value'][i] + 0.5*self.dictionary['theta']['value'][i],  roundingPrecision)
    ...
    def calc_lambda(self, roundingPrecision = 10, index = -1):                    #ok
        ...
        for i in range(firstIndex, lastIndex):
            ...
            while (lam < 10):
                ...
                #print("trim_eL {}".format(self.dictionary['trim_eL']['value'][i]))
                if(self.dictionary['trim_eL']['value'][i] > 0):
                    if(math.pow(self.dictionary['trim_eL']['value'][i], 1.1)==0):
                        print("pow = 0")
                    if(self.dictionary['CL0']['value'][i]!=0):
    ...
    def calc_beta_e(self, beta, roundingPrecision = 10, index = -1):   #need lambda first        #ok
        #assert (index >= -1), 'Out Of range Index given as parameter'
        #assert (isinstance(index, int)), 'Type Error for Index : given ' + str(type(index)) + ', must be ' + str(type(int()))
        if index == -1:
            firstIndex = 0
        ...
        theta_temp =  math.radians(self.dictionary['theta']['value'][0])
        for i in range(firstIndex, lastIndex):
            temp = math.degrees ( math.atan(   math.tan(beta_temp) + self.dictionary['lambda']['value'][i]*math.tan(theta_temp)  ))
    ...
    def calc_Vm(self, V, beta, roundingPrecision = 10, index = -1):         #ok    
        ...
        if index == -1:
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            temp = self.dictionary['lambda']['value'][i] * math.cos(math.radians(beta)) * math.cos(math.radians(self.dictionary['trim']['value'][i]))
            temp =V[i] * math.sqrt(1 - self.dictionary['CL_beta_d']['value'][i]/temp)
    ...
    def calc_Sf(self, B, roundingPrecision = 10, index = -1):            #ok
        ...
        if index == -1:
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            self.dictionary['Sf']['value'][i] = round(self.dictionary['lambda']['value'][i]*B*B/math.cos(math.radians(self.dictionary['beta_e']['value'][i])),  roundingPrecision)
    ...
    def calc_D(self, delta, roundingPrecision = 10, index = -1):            #ok
        ...
        if index == -1:
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            self.dictionary['D']['value'][i] = round(delta*math.tan(math.radians(self.dictionary['trim_eD']['value'][i])) + self.dictionary['Df']['value'][i]/math.cos(math.radians(self.dictionary['trim_eD']['value'][i])),  roundingPrecision)
    ...
    def calc_trimTabs_D (self, trimDelta, roundingPrecision = 10, index = -1):              #ok
        ...
        if index == -1:
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            self.dictionary['trimTabs_D']['value'][i] = round(self.dictionary['trimTabs_Df']['value'][i]*math.cos(math.radians(self.dictionary['trim']['value'][i] + trimDelta)) + self.dictionary['trimTabs_D_L']['value'][i],  roundingPrecision)
    ...
    def calc_Zprim(self, Z, LOA, roundingPrecision = 10, index = -1):     #need h                #ok
        ...
        if index == -1:
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            self.dictionary['Zprim']['value'][i] = round(Z/math.cos(math.radians(self.dictionary['trim']['value'][i])) + LOA*math.sin(math.radians(self.dictionary['trim']['value'][i])) - self.dictionary['h']['value'][i],  roundingPrecision)
    ...
    def calc_f_air(self, LCG, VCG, roundingPrecision = 10, index = -1):        #need h and Zprim              #ok
        ...
        for i in range(firstIndex, lastIndex):
            ...
            temp = temp - VCG * math.cos(math.radians(self.dictionary['trim']['value'][i]))
            temp = temp + LCG * math.sin(math.radians(self.dictionary['trim']['value'][i]))
    ...
    def calc_Fh(self, nbPropellers, roundingPrecision = 10, index = -1):                #ok
        ...
        for i in range(firstIndex, lastIndex):
            ...
            temp2 = nbPropellers * (self.dictionary['shaft_D']['value'][i] + self.dictionary['strut_D']['value'][i] + self.dictionary['rudder_D']['value'][i]) * math.cos(math.radians(self.dictionary['trim_eD']['value'][i]))
            temp3 = nbPropellers * self.dictionary['shaft_N']['value'][i] * math.sin(math.radians(self.dictionary['trim_eD']['value'][i]))
    ...
    def calc_Fv(self, nbPropellers, delta, roundingPrecision = 10, index = -1):                 #ok
        ...
        for i in range(firstIndex, lastIndex):
            ...
            temp2 = nbPropellers * (self.dictionary['shaft_D']['value'][i] + self.dictionary['strut_D']['value'][i] + self.dictionary['rudder_D']['value'][i]) * math.sin(math.radians(self.dictionary['trim_eD']['value'][i]))
            temp3 = nbPropellers * self.dictionary['shaft_N']['value'][i] * math.cos(math.radians(self.dictionary['trim_eD']['value'][i]))
    ...
    def calc_T(self, e, roundingPrecision = 10, index = -1):                #ok
        ...
        if index == -1:
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            self.dictionary['T']['value'][i] = round(self.dictionary['Fh']['value'][i]/math.cos(math.radians(self.dictionary['trim_eD']['value'][i]+e)),  roundingPrecision)
    ...
    def calc_Nt(self, e, roundingPrecision = 10, index = -1):              #ok
        ...
        if index == -1:
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            self.dictionary['Nt']['value'][i] = round(self.dictionary['Fv']['value'][i]*math.cos(math.radians(self.dictionary['trim_eD']['value'][i] + e)) + self.dictionary['Fh']['value'][i]*math.sin(math.radians(self.dictionary['trim_eD']['value'][i] + e)),  roundingPrecision)
    ...
    def calc_h(self, B, roundingPrecision = 10, index = -1):            #ok
        ...
        if index == - 1:
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            self.dictionary['h']['value'][i] = round(self.dictionary['lambda_k']['value'][i]*B*math.sin(math.radians(self.dictionary['trim']['value'][i])),  roundingPrecision)
    ...
    def calc_DELTA_s(self, B, roundingPrecision = 10, index = -1):              #ok
        ...
        for i in range(firstIndex, lastIndex):
            ...
            temp = temp * math.sin(math.radians(2*self.dictionary['trim']['value'][i]))
    ...
    def calc_KB(self, B, roundingPrecision = 10, index = -1):                   #ok
        ...
        if index == -1:
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            temp = B/6*math.tan(math.radians(self.dictionary['beta_e']['value'][i]))
    ...
    def calc_CL_beta_d2(self, roundingPrecision = 10, index = -1):                  #ok
        ...
        if index == -1:
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            temp = math.pi/4*(1-math.sin(math.radians(self.dictionary['beta_e']['value'][i])))*math.cos(math.radians(self.dictionary['trim_eL']['value'][i]))*self.dictionary['lambda']['value'][i]/(1+self.dictionary['lambda']['value'][i])
            temp = temp + 1.33/4*self.dictionary['lambda']['value'][i]*math.cos(math.radians(self.dictionary['trim_eL']['value'][i]))*math.sin(math.radians(2*self.dictionary['trim_eL']['value'][i]))*math.cos(math.radians(self.dictionary['beta_e']['value'][i]))
            self.dictionary['CL_beta_d2']['value'][i] = round(math.sin(math.radians(2*self.dictionary['trim_eL']['value'][i]))*temp,  roundingPrecision)
    ...
    def calc_drukpt(self, B, roundingPrecision = 10, index = -1):               #ok
        ...
        if index == -1:
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            self.dictionary['drukpt']['value'][i] = round(0.8*math.pi/4*B/2/math.cos(math.radians(self.dictionary['beta_e']['value'][i])),  roundingPrecision)
    ...
    def calc_arm(self, VCG, roundingPrecision = 10, index = -1):                #ok
        ...
        if index == -1:
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            self.dictionary['arm']['value'][i] = round(self.dictionary['drukpt']['value'][i] - VCG*math.sin(math.radians(self.dictionary['beta_e']['value'][i])),  roundingPrecision)
    ...
    def calc_Peff(self, V, roundingPrecision = 10, index = -1):                #ok
        ...
        if index == -1:
            ...
            lastIndex = index + 1
        for i in range(firstIndex, lastIndex):
            self.dictionary['Peff']['value'][i] = round(self.dictionary['Fh']['value'][i]*V[i]/550, roundingPrecision)
    ...
    def calc_planning(self, B, LWL, roundingPrecision = 10, index = -1):
        ...
        for i in range(firstIndex, lastIndex):
            if(LWL/B < self.dictionary['lambda_k']['value'][i]):
                self.dictionary['planning']['value'][i] = False
            else:
                self.dictionary['planning']['value'][i] = True
                
    def calc_verticalAcceleration(self, V, LOA, DELTA, LWL, beta, roundingPrecision = 10, index = -1):
        if index == -1:
            firstIndex = 0
            lastIndex = self.size
        else :
        ...
        #we are working with SI units for that one, we convert it in the end
            
        Crw = 0.6
        Kh = 1
        Hs = 0.25
        
        L = Units.distanceConversion(LOA,'ft','m',roundingPrecision)   #LOA must be in feet
        LWL_SI = Units.distanceConversion(LWL,'ft','m',roundingPrecision)   
        DELTA_SI = Units.massConversion(DELTA, 'lb', 'kg', roundingPrecision)
        
        
        for i in range(firstIndex, lastIndex):
            
            temp = 0
            ratio = V[i]/math.sqrt(L)
            #print("i = {}      ratio {}".format(i, ratio))
            
            if(ratio>=10.86):
                # print(1)
                k_pi = 1.5 - 0.046*ratio
                F_Nv = 0.5144 * self.dictionary['Fn_vol']['value'][i]
                
                temp = 8.38*9.81*k_pi / math.pow(L/math.pow(DELTA_SI,1/3), 0.35)
                temp = temp * (Hs/LWL_SI + 0.084) * (50-beta) * math.log(F_Nv)*V[i]
                temp = temp * math.sqrt(L) * LWL_SI * LWL_SI / 1000 / DELTA_SI
                
            elif(ratio>=3):
                # print(2)
                temp = Kh*9.81/1650*(Hs/LWL_SI+0.084)*(50-beta)*math.pow(ratio,2)
                temp = temp * LWL_SI * LWL_SI / DELTA_SI
                
            else:
                # print(3)
                temp = 6 * Hs/L*(0.85+0.35*ratio)*9.81
            
            self.dictionary['verticalAcceleration']['value'][i] = temp
    ...
    def calcAllConstants(self, roundingPrecision = 10, index = -1):
        ...
        self.calc_theta(self.inputDictionary['B']['value'], self.inputDictionary['LWL']['value'], self.inputDictionary['beta']['value'], self.inputDictionary['beta_x']['value'], roundingPrecision, index) 
    ...
    def calcAll(self, roundingPrecision = 10, index = -1):
        ...
        self.calc_trim_eL(roundingPrecision, index)     #ok
        self.calc_trim_eD(roundingPrecision, index)     #ok

        self.calc_lambda(roundingPrecision, index)  #need trim_eL
        
        self.calc_beta_e(self.inputDictionary['beta']['value'], roundingPrecision, index)  #need lambda         #ok
        ...
        self.calc_verticalAcceleration(self.inputDictionary['V']['SI'],self.inputDictionary['LOA']['value'], self.inputDictionary['DELTA']['value'], self.inputDictionary['LWL']['value'], self.inputDictionary['beta']['value'], roundingPrecision, index)
