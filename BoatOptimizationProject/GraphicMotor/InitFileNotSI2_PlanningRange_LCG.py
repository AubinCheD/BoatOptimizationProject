...
initialInputs = {    # 'key' : [value:float, unitType: string, unit: string, variationType, variation, displayedName: string, usedInGA: boolean]
    ...
    #Speed Values
    'V': {'unitType': 'Speed', 'unit1': 'knot', 'value1': [25,30,35,40,45,50], 'unit2': 'ft/s', 'SI': [], 'name': 'V'},  # [ou faire un autre tableau intermédiaire ?]
    ...
    'beta':     {'value': 10.0 , 'unitType': 'Angle',    'unit': '\u00B0', 'variationType': None, 'variation': 10.0, 'usedInGA': False, 'name': '\u03B2_transom'},
    'beta_x':   {'value': 10.0 , 'unitType': 'Angle',    'unit': '\u00B0', 'variationType': None, 'variation': 10.0, 'usedInGA': False, 'name': '\u03B2\u208E\u2080\u208D'},
    #'L_x': {'value': 0.0 , 'unitType': 'Distance', 'unit': '', 'variationType': None, 'variation': None, 'usedInGA': False, 'name': 'L\u208E\u2080\u208D'},    #not input
    'theta': {'value': 0.0 , 'unitType': 'Angle', 'unit': '\u00B0', 'variationType': None, 'variation': 10.0, 'usedInGA': False, 'name': '\u03B8'},        #not input ?
    'e':        {'value': 4.0 , 'unitType': 'Angle',    'unit': '\u00B0', 'variationType': None, 'variation': 10.0, 'usedInGA': False, 'name': '\u03E8'},
