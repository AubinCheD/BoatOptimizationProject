...
initialInputs = {    # 'key' : [value:float, unitType: string, unit: string, variationType, variation, displayedName: string, usedInGA: boolean]
    ...
    #hull
    'LWL':      {'value': 65 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': 'LWL'},
    'B':        {'value': 14 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': 'B'},
    'VCG':      {'value': 2 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 10.0, 'usedInGA': False, 'name': 'VCG'},
    'LCG':      {'value': 29 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': 'LCG'},
    'DELTA':    {'value': 60000 , 'unitType': 'Mass',    'unit': 'lb', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': '\u0394'},    ##CHECK UNIT
    'beta':     {'value': 10.0 , 'unitType': 'Angle',    'unit': '\u00B0', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': '\u03B2_transom'},
    'beta_x':   {'value': 10.0 , 'unitType': 'Angle',    'unit': '\u00B0', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': '\u03B2\u208E\u2080\u208D'},
    #'L_x': {'value': 0.0 , 'unitType': 'Distance', 'unit': '', 'variationType': None, 'variation': None, 'usedInGA': True, 'name': 'L\u208E\u2080\u208D'},    #not input
    'theta': {'value': 0.0 , 'unitType': 'Angle', 'unit': '\u00B0', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': '\u03B8'},        #not input ?
    'e':        {'value': 4.0 , 'unitType': 'Angle',    'unit': '\u00B0', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': '\u03E8'},
    'f':        {'value': 0.5 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': 'f'},
    ...
    #S/str
    'LOA':  {'value': 70 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': 'LOA'},
    'Bmax': {'value': 14 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': 'Bmax'},
    'Z':    {'value': 3 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': 'Z'},
    'Hss':  {'value': 5 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': 'Hss'},
    'Bss':  {'value': 7 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': 'Bss'},
    ...
    #trim tabs
    'TrimTab_chord': {'value': 0.0 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': 'Chord'},
