...
initialInputs = {    # 'key' : [value:float, unitType: string, unit: string, variationType, variation, displayedName: string, usedInGA: boolean]
    ...
    'beta':     {'value': 10.0 , 'unitType': 'Angle',    'unit': '\u00B0', 'variationType': None, 'variation': 20.0, 'usedInGA': True, 'name': '\u03B2_transom'},
    'beta_x':   {'value': 10.0 , 'unitType': 'Angle',    'unit': '\u00B0', 'variationType': None, 'variation': 20.0, 'usedInGA': True, 'name': '\u03B2\u208E\u2080\u208D'},
