...
initialInputs = {    # 'key' : [value:float, unitType: string, unit: string, variationType, variation, displayedName: string, usedInGA: boolean]
    ...
    #hull
    'LWL':      {'value': 65 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 20.0, 'usedInGA': False, 'name': 'LWL'},
    'B':        {'value': 14 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 20.0, 'usedInGA': False, 'name': 'B'},
    'VCG':      {'value': 2 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 20.0, 'usedInGA': True, 'name': 'VCG'},
    'LCG':      {'value': 29 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 20.0, 'usedInGA': True, 'name': 'LCG'},
    'DELTA':    {'value': 60000 , 'unitType': 'Mass',    'unit': 'lb', 'variationType': None, 'variation': 20.0, 'usedInGA': False, 'name': '\u0394'},    ##CHECK UNIT
    'beta':     {'value': 20.0 , 'unitType': 'Angle',    'unit': '\u00B0', 'variationType': None, 'variation': 20.0, 'usedInGA': True, 'name': '\u03B2_transom'},
    'beta_x':   {'value': 20.0 , 'unitType': 'Angle',    'unit': '\u00B0', 'variationType': None, 'variation': 20.0, 'usedInGA': True, 'name': '\u03B2\u208E\u2080\u208D'},
    ...
    'e':        {'value': 4.0 , 'unitType': 'Angle',    'unit': '\u00B0', 'variationType': None, 'variation': 20.0, 'usedInGA': True, 'name': '\u03E8'},
    'f':        {'value': 0.5 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 20.0, 'usedInGA': False, 'name': 'f'},
          
    #'Vmin': {'value': 0.0 , 'unitType': 'Speed', 'unit': '', 'variationType': None, 'variation': None, 'usedInGA': False, 'name': 'B'},         #not input
    #'Vmax': {'value': 0.0 , 'unitType': 'Speed', 'unit': '', 'variationType': None, 'variation': None, 'usedInGA': False, 'name': 'B'},       #not input

    #S/str
    'LOA':  {'value': 70 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 20.0, 'usedInGA': False, 'name': 'LOA'},
    'Bmax': {'value': 14 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 20.0, 'usedInGA': False, 'name': 'Bmax'},
    'Z':    {'value': 3 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 20.0, 'usedInGA': False, 'name': 'Z'},
    'Hss':  {'value': 5 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 20.0, 'usedInGA': False, 'name': 'Hss'},
    'Bss':  {'value': 7 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 20.0, 'usedInGA': False, 'name': 'Bss'},
    #'Ass': {'value': 0.0 , 'unitType': 'Area', 'unit': '', 'variationType': None, 'variation': None, 'usedInGA': False, 'name': 'Ass'},       #not input

    #Propulsion System

    'propellersNumber': {'value': 2.0 , 'unitType': None, 'unit': '', 'variationType': None, 'variation': 20.0, 'usedInGA': False, 'name': 'NbPropellers'},
    
    # #trim tabs
    # 'TrimTab_chord': {'value': 0.0 , 'unitType': 'Distance', 'unit': 'ft', 'variationType': None, 'variation': 10.0, 'usedInGA': False, 'name': 'Chord'},
    # 'TrimTab_sigma': {'value': 0.0 , 'unitType': None,       'unit': '', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': '\u03C3'},
    # 'TrimTab_delta': {'value': 0.0 , 'unitType': 'Angle',    'unit': '\u00B0', 'variationType': None, 'variation': 10.0, 'usedInGA': True, 'name': '\u03B4'},
    # #Rudder
